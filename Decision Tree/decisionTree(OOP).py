'''THIS IS A CLASS BASED (OOP) IMPLEMENTATION OF DECISION TREES.
THE REASON TO MAKE THIS IS AFTER LEARNING THE THEORY OF RANDOM FOREST,
A CLASS BASED DECISION TREE WILL MAKE IT MUCH EASIER TO IMPLEMENT IT.
NOTE: THIS FILE IS MADE **BEFORE** IMPLEMENTING RANDOM FORESTS BUT **AFTER** STUDYING IT'S THEORY '''
...
class DecisionTree:
    ...
    def information_gain(self, x, y):
        ...
        for col in range(x.shape[1]):
            ...
            for mp in midpoints:
                ...
                x_left, y_left, x_right, y_right = self.split_dataset(x, y, col, mp)
    ...
    def predict(self, x_new):
        ...
        while True:
            ...
            if x_new[current.feature] < current.threshold:
